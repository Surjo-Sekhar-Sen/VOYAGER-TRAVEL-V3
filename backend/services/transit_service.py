    ...
    def get_mini_path_options(self, source_lat: float, source_lng: float,
        ...
        for src_station in nearby_metro[:2]:
            for dst_station in dest_metro[:2]:
                ...
                if transit_dist < 0.5:
                    continue
                metro_fare_pp = max(15, round(transit_dist * 3))
